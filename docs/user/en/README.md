...
- LED behavior
- Release All and recovery
- RP2030 + FT232RL hardware-bridge setup

Names of settings, profile IDs, buttons, and error codes will remain identical across language versions.
